...
class Inicio extends CI_Controller {
	...
	{  
		...
		if (in_array($this->session->_permiso_rol, array("4", "5", "6", "7", "8"))) {
			...
			return;
		}else if (in_array($this->session->_permiso_rol, array("11", "12", "13","14","15","16","25"))) {
			//BUQUES
			...
			}else if (in_array($this->session->_permiso_rol, array("26"))) { //perfil Superviso operaciones(26)
				$SubMenu['submenu'] = array((object)array('id_submenu' => 73)); // Arribos y Zarpes
			}*/
