<div class="container">
    <div class="row">
        <div class="col-xs-12"><h3>Consultar solicitud de credenciales</h3></div>
    </div>
    <br>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center" >
                                <div class="p-1">
                                    <a href="#!">
                                        <span class="glyphicon glyphicon-print imprimir" aria-hidden="true"></span>
                                    </a>
                                </div>
                                <div class="p-1">
                                <a href="<?php echo base_url(); ?>Credencializacion/Ctrl_Credencializacion/administrar_solicitudes_autorizar">
                                        <span class="glyphicon glyphicon-envelope enviar" aria-hidden="true"></span>
                                    </a>
                                </div>
                                <div class="p-1">
                                    <a href="#!">
...
<div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnAceptarModalCredencial">Aceptar</button>
