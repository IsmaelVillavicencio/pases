    ...
    <div class="classregmanual">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control validar letra noespecial" maxlength="50" id="nombre" >
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control validar letra noespecial" maxlength="50" id="primer_apellido" >
                <span id="errorprimer_apellido" style="color:red; display:none;">Campo obligatorio</span>
            </div>
            <div class="col-md-4">
                Segundo apellido:
                <input type="text" class="form-control letra noespecial" maxlength="50" id="segundo_apellido" >
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="selNacionalidad" class="form-control validar">
                </select>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <span id="errorrfc2" style="color:red; display:none;"></span>
            </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="divclaveelector" style="display: none;">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <span id="errorfechaNacimiento" style="color:red; display:none;"></span>
                    <span id="errorfechaNacimiento2" style="color:red;"></span>
                </div>
                <div class="col-md-4">
                    <br>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnAceptarAdjuntarIfe">Aceptar</button>
...
<div class="modal" id="modalFoto" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="btnAceptarAdjuntarFoto">Aceptar</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
    </div>
