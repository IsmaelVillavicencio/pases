        ...
        <div class="tab-pane fade in active" id="operador">
          <div class="row">
            ...
            <div class="row m-0" hidden id="divOperadoresExcel">
              <div class="col-xs-12">
                <br><br>Descargue el archivo para capturar la información necesaria para el registro de choferes:<br><br>
                <button class="btn btn-default" id="descargarArchivoOperador">Decargar archivo</button>
              </div>
              <div class="col-xs-12">
        ...
        <div class="tab-pane fade" id="contenedor">
          <div class="row">
            ...
            <div class="row m-0" id="divContenedoresExcel" hidden>
              <div class="col-xs-12">
                <br><br>Descargue el archivo para capturar la información necesaria para el registro de choferes:<br><br>
                <button class="btn btn-default">Decargar archivo</button>
              </div>
              <div class="col-xs-12">
                <br><br>Subir documentos excel<br><br>
        ...
        <div class="tab-pane fade" id="tracto">
          <div class="row">
            ...
            <div class="row m-0" id="divTractosExcel" hidden>
              <div class="col-xs-12">
                <br><br>Descargue el archivo para capturar la información necesaria para el registro de choferes:<br><br>
                <button class="btn btn-default" id="descargarArchivoTracto">Decargar archivo</button>
              </div>
              <div class="col-xs-12">
                <br><br>Subir documentos excel<br><br>
        ...
        <div class="tab-pane fade" id="vehiculo">
          <div class="row">
            ...
            <div class="row m-0" id="divVehiculosExcel" hidden>
              <div class="col-xs-12">
                <br><br>Descargue el archivo para capturar la información necesaria para el registro de choferes:<br><br>
                <button class="btn btn-default" id="descargarArchivoVehiculo">Decargar archivo</button>
              </div>
              <div class="col-xs-12">
                <br><br>Subir documentos excel<br><br>
