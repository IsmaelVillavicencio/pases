...
<div class="container">
  <div class="row capamenu">
                ...
                <?php }if($this->session->_permiso_rol == 5){ ?>
                  <div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
                    <a id="permisosCabotaje" class="btn bg-transparent" href="<?php echo base_url("Permisos/Ctrl_Cabotaje/index"); ?>">
											<img id="permisosCabotaje" src="<?php echo base_url('assets/iconos/PermisodeCabotaje/PermisosdecabotajeNIV3Recurso22xhdpi.png'); ?>">
                      <span class="p-ink" style="height: 228px; width: 228px; top: 46px; left: 1px;"></span>
                    </a>
    ...
    $roles = array("11", "12","13","14","15","16","25","27");
    if (in_array($this->session->_permiso_rol, $roles)) {
			if(isset($menu)){
        foreach ($menu as $option) {
          if($option->id_menu == 4){
            if(isset($submenu)){ ?>
							<?php if (in_array($this->session->_permiso_rol, array("11","12","14","16"))){ ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
									...
									<div id="textDialogbuques" class="textDialog" hidden>Buques </div>
								</div>
							<?php } ?>
							<?php if (in_array($this->session->_permiso_rol, array("11","12","13","14","15","25"))){ ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
							...
							<?php } ?>
							<?php if (in_array($this->session->_permiso_rol, array("11","12","13","14"))){ ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
							...
							<?php if($option->id_submenu == 67 ) { ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
									<a id="solicitud_autorizacion_desembarque" class="btn bg-transparent" href="<?php echo base_url("Buques/SolicitudesDesembarque/Ctrl_Solicitud_Desembarque"); ?>">
										<img id="img_solicitud_autorizacion_desembarque" src="<?php echo base_url('assets/iconos/Buques/Migracion/SOLICITUD_DE_AUTORIZACION_DE_DESEMBARQUE.png'); ?>">
										<span class="p-ink" style="height: 228px; width: 228px; top: 46px; left: 1px;"></span>
									</a>
							...
							<?php if($option->id_submenu == 66 ) { ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
									<a id="solicitud_internacion" class="btn bg-transparent" href="<?php echo base_url("Buques/SolicitudesEmbarque/Ctrl_Solicitud_Embarque"); ?>">
										<img id="img_solicitud_internacion" src="<?php echo base_url('assets/iconos/Buques/Migracion/SOLICITUD_DE_AUTORIZACION_DE_EMBARQUE.png'); ?>">
										<span class="p-ink" style="height: 228px; width: 228px; top: 46px; left: 1px;"></span>
									</a>
						...
						foreach ($submenu as $key => $option) {?>
							...
							<?php if($option->id_submenu == 46 ) { ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
									...
									<h5 id="titlemarco_operativo">Marco Operativo</h5>
									<div id="textDialogmarco_operativo" class="textDialog" hidden>Marco Operativo  </div>
								</div>
							<?php } ?>
						...
						foreach ($submenu as $key => $option) {?>
							...
							<?php if($option->id_submenu == 44 ) { ?>
								<div class="col-md-3 col-sm-4 col-xs-6 text-center mt-5">
									...
									<h5 id="titleautorizar_libre_platica">Solicitud de Libre Plática </h5>
									<div id="textDialogautorizar_libre_platica" class="textDialog" hidden>Solicitud de Libre Plática </div>
								</div>
							<?php } ?>
						<?php }
					}
