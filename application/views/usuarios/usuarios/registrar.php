<div class="container">
    <div class="row">
        <div class="col-xs-12"><br><h3>Registrar usuario</h3></div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <br>
            <span class="required">*</span><span> Personal API:</span>
            <select id="selPersonal" class="form-control" style="width:100%">
                <option value=""></option>
            </select>
            <span id="errorPersonalApi" style="color: red; display: none;">Campo obligatorio</span>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4">
