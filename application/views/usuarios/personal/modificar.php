<div class="container">
    <div class="row">
        <div class="col-xs-12"><br><br><h3>Modificar personal ejecutivo</h3></div>
    </div>
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4  col-sm-6">
			<br>
			<button class="btn btn-light visible-xs hidden-sm-up hidden-xs-up hidden-md-up">Escanear CURP</button>
			<button class="btn btn-light escanear-escaner hidden-xs hidden-sm-down hidden-md-down hidden-xl-down mt-md-5">Escanear CURP</button>
		</div>
        <div class="col-xs-12 col-md-4  col-sm-6">
            <br>
        ...
        <div class="col-xs-12 col-md-4  col-sm-6">
            ...
            <select id="selNacionalidad" class="form-control validar" disabled>
        ...
        <div class="col-xs-12 col-md-4  col-sm-6">
            ...
            <select class="form-control validar" id="estadonacimiento"></select>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4 col-sm-6">
            ...
            <input type="text" id="estado" class="form-control" value="" required disabled>
            <span id="errorestado" style="color:red; display:none;">Campo obligatorio</span>
        </div>
        <div class="col-xs-12 col-md-4 col-sm-6">
            <br>
            <span class="required">*</span><span> Municipio:</span>
            <input type="text" id="municipio" class="form-control" value="" required disabled>
        ...
        <div class="col-xs-12 col-md-4 col-sm-6">
            ...
            <span id="errorentreCalle1"style="color:red; display:none;">Formato incorrecto</span>
        </div>
        <div class="col-xs-12 col-md-4 col-sm-6">
            <br>Entre calle 2:
            <input type="text" id="entreCalle2" class="form-control espe" value="" required>
            <span id="errorentreCalle2"style="color:red; display:none;">Formato incorrecto</span>
        </div>
    </div>
    <div class="row">
