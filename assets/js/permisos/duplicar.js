                    ...
                    if (response.data.vehiculo.data != "") {
                        ...
                        response.data.vehiculo.data.forEach(element => {
                            let datos = {
                                ...
                                noPlaca: (element.numero_placa != null ? element.numero_placa : ''),
                                noSerie: element.numero_serie,
                                noMotor: (element.numero_motor != null ? element.numero_motor : ''),
                                marca: (element.marca != null ? element.marca : ''),
                                modelo: element.modelo,
                                anio: element.anio,
                                color:(element.color != null ? element.color : ''),
                                tipoVehiculo: element.id_tipo_vehiculo,
                                tipoTarCircu: (element.id_tipo_tarjeta_circulacion != null ? element.id_tipo_tarjeta_circulacion : 0),
                                noTarjeta: (element.numero_tarjeta_circulacion != null ? element.numero_tarjeta_circulacion : ''),
                                aseguradora: (element.id_tipo_aseguradora != null ? element.id_tipo_aseguradora : 0),
                                noPoliza: (element.numero_poliza != null ? element.numero_poliza : ''),
                                vigenciaPoliza: (element.vigencia_poliza != null ? element.vigencia_poliza : ''),
                                periodoPago: (element.id_tipo_periodo != null ? element.id_tipo_periodo : 0),
                                periodoFechaInicio: (element.fecha_inicio_cobertura != null ? element.fecha_inicio_cobertura : ''),
                                periodoFechaFin: (element.fecha_fin_cobertura != null ? element.fecha_fin_cobertura : ''),
...
$(tabPersonal).on('click', '.modificar-persona', function (ev) {
    ...
    empresa_rfc.value = datosPersonal[ev.target.dataset.idindextblmodpersonas].rfc
...
$(tabVehiculos).on('click', '.modificar-vehiculo', function (ev) {
    ...
    datosVehiculos[ev.target.dataset.idindextblmodvehiculos].opcion = 2
    posicionIndex = ev.target.dataset.idindextblmodvehiculos
